...
export const AdvisoriesFilterMessages = defineMessages({
    ...
    disclaimerBody: {
        ...
        defaultMessage: 'The advisories and airspaces you see are what is currently scheduled. Always check for new NOTAMS and advisories before you intend to fly.'
    },
    reset: {
