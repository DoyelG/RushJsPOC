export function AdvisoryDetail({ advisory: { properties: { body, description, ...properties }, type, name, color, schedule, requirements, isActive, isActiveUnknown, counter, ...advisoryData }, showAdvisoryType, handleSelectAdvisory, isAdvisorySelected }: {
    advisory: {
        [x: string]: any;
        properties: {
            [x: string]: any;
...
export namespace AdvisoryDetail {
